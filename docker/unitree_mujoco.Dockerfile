...
RUN python3 -m pip install --no-cache-dir numpy scipy matplotlib pandas pyyaml mujoco imageio imageio-ffmpeg pygame pillow
...
RUN python3 -m pip install --no-cache-dir -e /workspace/unitree_sdk2_python
