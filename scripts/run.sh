...
usage() {
  echo "Usage: $0 [build|validate-assets|prepare-assets|validate-deploy|validate-images|smoke-release-gate|smoke-sim-bridge|smoke-holomotion|smoke-sonic-build|all]"
}
